 ...
 * ::rs_loglevel.
 */
static const char *rs_severities[] = {"EMERGENCY! ", "ALERT! ", "CRITICAL! ", "ERROR: ", "Warning: ", "", "", ""};
 ...
 * tracing?
 */
void rs_trace_to(rs_trace_fn_t *new_impl) { rs_trace_impl = new_impl; }

void rs_trace_set_level(rs_loglevel level) { rs_trace_level = level; }
